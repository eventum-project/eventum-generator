              ...
              <form onSubmit={form.onSubmit(handleSubmit)}>
                <Stack>
                  ...
                  <Alert
                    variant="default"
                    icon={
                      <Box c="orange" component={IconLockExclamation}></Box>
                    }
                  ...
                  >
                    Formed batch preserve its size throughout the entire
                    workflow of plugins. At event plugin stage, batch is
                    expanded from timestamps to events. So, for large events,
                    smaller batch sizes are preferred.
                  </Alert>
                  <Title order={3} fw={500} mt="md">
                    Queue
                  </Title>
                ...
                >
                  ...
                  <Group justify="end" mt="lg">
                    <Button variant="default" onClick={closeSubmitModal}>
                      Cancel
                    </Button>
